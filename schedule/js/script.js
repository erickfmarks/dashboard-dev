  ...
  const calendar = new FullCalendar.Calendar(calendarEl, {
    ...
    customButtons: {
      customButton: {
        ...
        click: function () {
          ...
          modalTitle.innerHTML = 'Adicionar evento'
    ...
    eventRender: function (info) {
      info.el.addEventListener('contextmenu', function (e) {
        ...
        <li><i class="fas fa-trash-alt"></i>Deletar</li>
        </ul>`;
        ...
        menu.querySelector('li:last-child').addEventListener('click', function () {
          ...
          modalBody.innerHTML = `Você tem certeza que deseja deletar o evento: <b>"${info.event.title}"?</b>`
          deleteModal.show();
